...
class _TutorHomeScreenState extends State<TutorHomeScreen> {
  ...
  Widget _buildOptionRow(int index) {
    ...
    if (showResult && isCorrect) {
      textColor = const Color(0xFF059669); bgColor = const Color(0xFF059669).withOpacity(0.1);
    } else if (showResult && isSelected && !isCorrect) {
      textColor = const Color(0xFFDC2626); bgColor = const Color(0xFFDC2626).withOpacity(0.1);
    } else if (isSelected) {
